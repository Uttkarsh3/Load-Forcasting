...
Presumably, electricity demand is relatively higher at times when people are most likely to be indoors
in the eveninig.
"""
    )
...
This results in the u-shaped plot seen in the plot, showing the non-linearily that exist between
